<div class="site-header" style="background-color:#de5a0a; color:white">
				<nav class="navbar navbar-light" style="background-color:#de5a0a; color:white">
					<div class="navbar-left" style="background-color:#fff; color:white">
						<a class="navbar-brand" href="index.php">
							<img src="img/logo/<?php if(isset($setting_logo1)){ echo $setting_logo1;}?>" style="width:100%" class="logo" >
						</a>
