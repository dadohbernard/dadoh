...
@$receivableper=round((($receivable/$revenuee)*100),2);  //Total Receivable data
@$total_discountper=round((($total_discount/$revenuee)*100),2); //Total Discount data
@$paid_amountper=round((($paid_amount/$revenuee)*100),2);   //Total Paid amount data
	}else{
