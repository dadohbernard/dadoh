...
<head>
        ...
        <link rel="stylesheet" href="../wms/select2/dist/css/select2.min.css">
        <link rel="stylesheet" href="../wms/bootstrap-tagsinput/dist/bootstrap-tagsinput.css">
		<link rel="stylesheet" href="../wms/multi-select/css/multi-select.css">
		<link rel="stylesheet" href="../wms/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css">
        <link rel="stylesheet" href="../wms/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
		<link rel="stylesheet" href="../wms/bootstrap-daterangepicker/daterangepicker.css">
		<!-- Neptune CSS -->
	...
	<body class="fixed-sidebar fixed-header skin-3 content-appear">
						...
						<div class="box box-block bg-white">
							...
							<div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="hidden" class="form-control" autocomplete="off" value="<?php if(isset($datepicker_exp_date)){ echo $datepicker_exp_date;}?>" id="datepicker_exp_date" name="datepicker_exp_date" placeholder="yyyy-mm-dd">
		...
		<script type="text/javascript" src="../wms/nprogress/nprogress.js"></script>
     	<script type="text/javascript" src="../wms/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
		<script type="text/javascript" src="../wms/clockpicker/dist/jquery-clockpicker.min.js"></script>
		<script type="text/javascript" src="../wms/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
		<!-- Neptune JS -->
