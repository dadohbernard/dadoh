							...
							<div class="card-block" >
								<div class="row mb-2">
									<div class="col-sm-8 col-xs-6">										
                                        <img style="width: 25%" src="img/logo/<?php if(isset($setting_logo1)){ echo $setting_logo1;}?>" >
                                <!--         <h5><?php// if(isset($setting_name1)){ echo $setting_name1;}?>,</h5> -->
										
										<p><?php if(isset($setting_address1)){ echo $setting_address1;}?>
											<?php //if(isset($setting_city1)){ echo $setting_city1;}?>
											<?php// if(isset($setting_country1)){ echo $setting_country1;}?></p>
